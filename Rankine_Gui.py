...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lbl_PHigh = QtWidgets.QLabel(self.groupBox)
        ...
        self.lbl_PLow = QtWidgets.QLabel(self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.le_PLow = QtWidgets.QLineEdit(self.groupBox)
        ...
        self.le_PHigh = QtWidgets.QLineEdit(self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.le_TurbineInletCondition = QtWidgets.QLineEdit(self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.lbl_TurbineInletCondition = QtWidgets.QLabel(self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.le_TurbineEff = QtWidgets.QLineEdit(self.groupBox)
        ...
        self.le_H1 = QtWidgets.QLineEdit(self.groupBox_2)
        self.le_H1.setEnabled(False)
        self.le_H1.setObjectName("le_H1")
        self.gridLayout_2.addWidget(self.le_H1, 2, 2, 1, 1)
        self.le_H4 = QtWidgets.QLineEdit(self.groupBox_2)
        self.le_H4.setEnabled(False)
        self.le_H4.setObjectName("le_H4")
        self.gridLayout_2.addWidget(self.le_H4, 5, 2, 1, 1)
        self.le_H3 = QtWidgets.QLineEdit(self.groupBox_2)
        self.le_H3.setEnabled(False)
        self.le_H3.setObjectName("le_H3")
        self.gridLayout_2.addWidget(self.le_H3, 4, 2, 1, 1)
        ...
        self.le_H2 = QtWidgets.QLineEdit(self.groupBox_2)
        self.le_H2.setEnabled(False)
        self.le_H2.setObjectName("le_H2")
        self.gridLayout_2.addWidget(self.le_H2, 3, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_10, 5, 4, 1, 1, QtCore.Qt.AlignRight)
        self.le_Efficiency = QtWidgets.QLineEdit(self.groupBox_2)
        self.le_Efficiency.setEnabled(False)
        self.le_Efficiency.setObjectName("le_Efficiency")
        self.gridLayout_2.addWidget(self.le_Efficiency, 5, 5, 1, 1)
        self.le_HeatAdded = QtWidgets.QLineEdit(self.groupBox_2)
        self.le_HeatAdded.setEnabled(False)
        self.le_HeatAdded.setObjectName("le_HeatAdded")
        self.gridLayout_2.addWidget(self.le_HeatAdded, 4, 5, 1, 1)
        ...
        self.le_PumpWork = QtWidgets.QLineEdit(self.groupBox_2)
        self.le_PumpWork.setEnabled(False)
        self.le_PumpWork.setObjectName("le_PumpWork")
        self.gridLayout_2.addWidget(self.le_PumpWork, 3, 5, 1, 1)
        self.le_TurbineWork = QtWidgets.QLineEdit(self.groupBox_2)
        self.le_TurbineWork.setEnabled(False)
        self.le_TurbineWork.setObjectName("le_TurbineWork")
        self.gridLayout_2.addWidget(self.le_TurbineWork, 2, 5, 1, 1)
        self.label_13 = QtWidgets.QLabel(self.groupBox_2)
        self.label_13.setObjectName("label_13")
        self.gridLayout_2.addWidget(self.label_13, 3, 6, 1, 1)
        self.label_16 = QtWidgets.QLabel(self.groupBox_2)
        self.label_16.setObjectName("label_16")
        self.gridLayout_2.addWidget(self.label_16, 4, 6, 1, 1)
        self.label_12 = QtWidgets.QLabel(self.groupBox_2)
        self.label_12.setObjectName("label_12")
        self.gridLayout_2.addWidget(self.label_12, 5, 6, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.le_PLow.setText(_translate("Form", "10.00"))
